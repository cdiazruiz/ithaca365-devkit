...
from ithaca365.panoptic.panoptic_utils import STUFF_START_CLASS_ID
from ithaca365.utils.data_classes import LidarSegPointCloud
from ithaca365.utils.geometry_utils import points_in_box


def generate_panoptic_labels(nusc: Ithaca365, out_dir: str, verbose: bool = False) -> None:
    """
...
def main():
    ...
    nusc = Ithaca365(version=args.version, dataroot=args.dataroot, verbose=args.verbose)
