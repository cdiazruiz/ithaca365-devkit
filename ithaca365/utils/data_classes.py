...
from ithaca365.lidarseg.lidarseg_utils import colormap_to_colors, create_lidarseg_legend
from ithaca365.utils.data_io import load_bin_file
from ithaca365.utils.geometry_utils import view_points, transform_matrix
...
class LidarPointCloud(PointCloud):
    ...
    @classmethod
    def from_file(cls, file_name: str, nrb_channels=4) -> 'LidarPointCloud':
        """
        Loads LIDAR data from binary numpy format. Data is stored as (x, y, z, intensity, ring index).
        :param file_name: Path of the pointcloud file on disk.
        :param nrb_channels: Number of channels in the file
        ...
        points = scan.reshape((-1, nrb_channels))[:, :cls.nbr_dims()]
        return cls(points.T)
